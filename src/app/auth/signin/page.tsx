...
const SignIn: React.FC = () => {
  const getCookiess = getCookie("loginTime");

  console.log(getCookiess, "GETCOOKIES");
  ...
  const schema = Yup.object().shape({
    ...
    email: Yup.string().email("Invalid Email Adrees").required(),
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white p-34 shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap items-center">
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <h2 className="mb-9 text-2xl font-bold text-[#3C50E0] dark:text-white sm:text-title-xl2">
              Sign In to Program Manager
            </h2>
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 text-black outline-none focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary ${errors.email && touched.email ? "border-red dark:border-red" : "border-stroke"}`}
                  />
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full rounded-lg border  bg-transparent py-4 pl-6 pr-10 text-black outline-none  focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary ${errors.password && touched.password ? "border-red dark:border-red" : "border-stroke"}`}
                  />
                  ...
                  {showPassword ? (
                    <svg
                      ...
                      className="dark:text-gray-300 absolute right-0 top-[20px] mr-3 h-5"
                      fill="none"
                      viewBox="0 0 576 512"
                    >
                      <path
              ...
              <div className="flex justify-between">
                ...
                <Link
                  href={"/auth/signup"}
                  className="flex justify-center pt-2 text-primary"
                >
                  Create New Account ?
                </Link>
