...
const DropdownUser = () => {
  ...
  const handlelogout = () => {
    const logout = deleteCookie("token");
    router.push('/auth/signin')
  }
  // console.log(handlelogout, "AAAAAA")
    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs">Program Manager</span>
        </span>
      ...
      >
        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
          ...
          <li>
            <Link
              href="/auth/login_activites"
              className="flex items-center gap-2 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
            >
              <svg fill="lightgray" width="30px" height="30px" viewBox="0 0 24 24">
                <g data-name="activity">
                  <rect width="20" height="24" transform="rotate(90 12 12)" opacity="0" />
