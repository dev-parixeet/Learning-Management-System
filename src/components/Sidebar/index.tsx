          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <li>
                ...
                >
                  <svg width="20" className="fill-current" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/course" || pathname.includes("forms")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "//course" ||
              ...
              <li>
                ...
                >
                  <svg fill="white" height="20px" width="20px"
                    viewBox="0 0 512 512">
                    <g>
                      <g>
                        <g>
